...
class FeaturedAdsController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(FeaturedAdsCell.self, forCellWithReuseIdentifier: cellId)
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! FeaturedAdsCell
    ...
    func fetchAds() {
        ...
        let ref = Database.database().reference().child("Feature_ads").child(uid)
