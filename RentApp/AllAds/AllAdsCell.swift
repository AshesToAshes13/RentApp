...
class AllAdsCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        // cell width = 180 cell height = 240
        // image height = 115 image width = cell width
        // all text data = 120
        // text data for 1 element = 20
    ...
    func setupLabels() {
        ...
        costAndCostValueStackView.spacing = -10
        ...
        squareAndSquareValueStackView.spacing = -10
        ...
        let allDataStackView = UIStackView(arrangedSubviews: [objectLabel, dealLabel, priceLabel, squareLabele, cityLabel , neighborhoodLabel])
